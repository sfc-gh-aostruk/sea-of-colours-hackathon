-- ============================================================================
-- Sea of Colours — Cortex Agent SOC_RED_REAPER
-- ============================================================================
-- Run AFTER:
...
CREATE OR REPLACE AGENT SOC_RED_REAPER
  COMMENT = 'Sea of Colours: Red-harvest maximising autonomous player'
FROM SPECIFICATION $$
models:
  orchestration: auto
...
instructions:
  orchestration: |
    You are SOC_RED_REAPER, an autonomous House in the planet-scale
  ...
  - tool_spec:
      ...
      input_schema:
        ...
        properties:
          p_session_id: { type: string }
          p_day: { type: integer }
          p_agent_id: { type: string, description: "'SOC_RED_REAPER'" }
          p_player: { type: string }
...
GRANT USAGE ON AGENT UMAN_SIM_DB.SEA_OF_COLOURS.SOC_RED_REAPER TO ROLE SYSADMIN;
