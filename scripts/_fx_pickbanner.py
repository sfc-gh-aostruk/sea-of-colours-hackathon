...
Scratch harness, like the other ``scripts/_fx_*.py`` — not a test.

Usage::

    python scripts/_fx_pickbanner.py --base http://127.0.0.1:8022
...
OUT = pathlib.Path(__file__).resolve().parents[1] / "reports" / "pickbanner"
