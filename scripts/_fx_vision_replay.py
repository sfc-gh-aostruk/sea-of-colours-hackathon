...
``scripts/_fx_vision.py`` drives hand-built boards, which only ever exercise
...
Scratch harness, like the other ``scripts/_fx_*.py`` — not part of pytest.

    python scripts/_fx_vision_replay.py [base_url] [session_id]
"""
