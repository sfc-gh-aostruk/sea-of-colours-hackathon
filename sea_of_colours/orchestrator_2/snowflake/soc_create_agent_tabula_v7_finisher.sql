-- ============================================================================
-- Sea of Colours — Cortex Agent SOC_RED_REAPER_TABULA_V7_FINISHER
-- ============================================================================
-- Companion to SOC_RED_REAPER_TABULA_V7. Same base model (haiku-4.5) and
...
CREATE OR REPLACE AGENT SOC_RED_REAPER_TABULA_V7_FINISHER
  COMMENT = 'Sea of Colours Tabula v7 continuation finisher — completes partial JSON plans from the primary strategist (haiku-4.5, JSON-only response).'
FROM SPECIFICATION $$
models:
...
instructions:
  orchestration: |
    You are SOC_RED_REAPER_TABULA_V7_FINISHER, a JSON completion service
