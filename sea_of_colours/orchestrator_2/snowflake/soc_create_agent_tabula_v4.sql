-- ============================================================================
-- Sea of Colours — Cortex Agent SOC_RED_REAPER_TABULA_V4
-- ============================================================================
-- Tabula v4 — probe intelligence (v2) PLUS:
...
CREATE OR REPLACE AGENT SOC_RED_REAPER_TABULA_V4
  COMMENT = 'Sea of Colours Tabula v4 — opponent-aware harvest pilot with blue fallback, hot drops, and orbit→tactical wishlist (haiku-4.5).'
FROM SPECIFICATION $$
models:
...
instructions:
  orchestration: |
    You are SOC_RED_REAPER_TABULA_V4, an arena pilot for Sea of Colours.
