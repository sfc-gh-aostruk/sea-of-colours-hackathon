-- ============================================================================
-- Sea of Colours — Cortex Agent SOC_RED_REAPER_TABULA_V6
-- ============================================================================
-- Tabula v6 — doctrine-comprehension rewrite (no new game mechanics):
...
CREATE OR REPLACE AGENT SOC_RED_REAPER_TABULA_V6
  COMMENT = 'Sea of Colours Tabula v6 — state-triggered doctrine harvest pilot (lean core + conditional blue/redsign/weapon appendices, haiku-4.5).'
FROM SPECIFICATION $$
models:
...
instructions:
  orchestration: |
    You are SOC_RED_REAPER_TABULA_V6, an arena pilot for Sea of Colours.
