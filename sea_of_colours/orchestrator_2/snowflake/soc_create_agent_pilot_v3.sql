-- ============================================================================
-- Sea of Colours — Cortex Agent SOC_RED_REAPER_PILOT_V3
-- ============================================================================
...
CREATE OR REPLACE AGENT SOC_RED_REAPER_PILOT_V3
...
instructions:
  orchestration: |
    You are SOC_RED_REAPER_PILOT_V3 — a MASTER HARVESTER. Your job each
...
GRANT USAGE ON AGENT UMAN_SIM_DB.SEA_OF_COLOURS.SOC_RED_REAPER_PILOT_V3 TO ROLE SYSADMIN;
GRANT USAGE ON PROCEDURE UMAN_SIM_DB.SEA_OF_COLOURS.SOC_SUBMIT_POLICY(STRING, STRING, STRING) TO ROLE SYSADMIN;

DESCRIBE AGENT SOC_RED_REAPER_PILOT_V3;
