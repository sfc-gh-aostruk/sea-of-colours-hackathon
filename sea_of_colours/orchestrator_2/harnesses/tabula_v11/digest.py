...
def format_self_execution_block(
    ...
    *you* did: the plan you committed, what the CORRECTOR changed and why, and
    ...
    if not (plan_ids or planned or corrector) and moves_exec is None:
        return ""
    ...
    out: List[str] = [
        f"YOUR OWN LAST NIGHT — PLAN vs CORRECTOR vs EXECUTED (day {day}). This "
        "is the engine record of what YOU did; reconcile your reflection to it:"
    ]
