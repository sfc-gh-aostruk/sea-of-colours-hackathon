...
=== v10 AGENCY FIELDS (put these RIGHT AFTER "posture", before "reasoning") ===
  ...
  "avoid": [[x,y], ...] — up to 3 cells you have REASONED are unsafe to touch
      (a spot a rival will crash, a cell you think is already stripped, a mirror
      collision point). The compiler now HONOURS this too: it will REFUSE to
      drop on or step onto them. Only list cells you are confident about — a
      wrong avoid can block a good grab.
