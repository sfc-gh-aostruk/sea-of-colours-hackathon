> ### This directory is yours — AOSTRUK2_DESTROYER
>
...
```44:75:sea_of_colours/orchestrator_2/harnesses/aostruk2_destroyer/orbit_policy.py
...
```43:43:sea_of_colours/orchestrator_2/harnesses/aostruk2_destroyer/_v7/chat_schema.py
...
Prefer changing `aostruk2_destroyer/` proper; touch `_v7/` only for shared
...
| --- | --- | --- |
| `AOSTRUK2_DESTROYER_SINGLE` | `0` | `1` skips the THINK/PLAN split — one LLM call, faster, dumber |
| `AOSTRUK2_DESTROYER_AUTOFILL` | `0` | `1` lets the packager top up a short plan |
