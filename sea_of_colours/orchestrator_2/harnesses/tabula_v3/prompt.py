...
from sea_of_colours.orchestrator_2.harnesses.tabula_v3.rules import (
    RULES_SUMMARY,
)
from sea_of_colours.orchestrator_2.harnesses.tabula_v3.strategies import (
    STRATEGIES_SUMMARY,
    DOCTRINE_BEWARE_EMP,
    DOCTRINE_BEWARE_CHAFF,
)
from sea_of_colours.orchestrator_2.harnesses.tabula_v3.orbit_wishlist import (
    Wishlist,
)
