...
Flow per turn:
  ...
  5. Invoke Cortex agent SOC_RED_REAPER_TABULA_V3 (single call, ~30s)
...
from sea_of_colours.orchestrator_2.harnesses.tabula_v3 import (
    heuristic_chains,
    memory,
    opponent_weapons,
    orbit_stub,
...
AGENT_NAME = "SOC_RED_REAPER_TABULA_V3"
INNER_AGENT_LABEL = "TABULA_V3"
...
FINISHER_AGENT_NAME = "SOC_RED_REAPER_TABULA_V3_FINISHER"
