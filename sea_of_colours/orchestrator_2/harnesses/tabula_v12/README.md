...
```43:43:sea_of_colours/orchestrator_2/harnesses/tabula_v12/_v7/chat_schema.py
...
Prefer changing `tabula_v12/` proper; touch `_v7/` only for shared
...
| --- | --- | --- |
| `TABULA_V12_SINGLE` | `0` | `1` skips the THINK/PLAN split — one LLM call, faster, dumber |
| `TABULA_V12_AUTOFILL` | `0` | `1` lets the packager top up a short plan |
