...
from sea_of_colours.orchestrator_2.harnesses.emp_harvest_test._v7.rules import (
    RULES_SUMMARY,
)
from sea_of_colours.orchestrator_2.harnesses.emp_harvest_test._v7.strategies import (
    STRATEGIES_CORE,
    DOCTRINE_BLUE,
    DOCTRINE_REDSIGN,
