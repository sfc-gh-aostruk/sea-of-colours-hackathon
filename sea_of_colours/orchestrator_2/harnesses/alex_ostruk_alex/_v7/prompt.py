...
from sea_of_colours.orchestrator_2.harnesses.alex_ostruk_alex._v7.rules import (
    RULES_SUMMARY,
)
from sea_of_colours.orchestrator_2.harnesses.alex_ostruk_alex._v7.strategies import (
    STRATEGIES_CORE,
    DOCTRINE_BLUE,
    DOCTRINE_REDSIGN,
