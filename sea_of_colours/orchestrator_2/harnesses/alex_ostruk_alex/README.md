...
```44:75:sea_of_colours/orchestrator_2/harnesses/alex_ostruk_alex/orbit_policy.py
...
```43:43:sea_of_colours/orchestrator_2/harnesses/alex_ostruk_alex/_v7/chat_schema.py
...
Prefer changing `alex_ostruk_alex/` proper; touch `_v7/` only for shared
...
| --- | --- | --- |
| `ALEX_OSTRUK_ALEX_SINGLE` | `0` | `1` skips the THINK/PLAN split — one LLM call, faster, dumber |
| `ALEX_OSTRUK_ALEX_AUTOFILL` | `0` | `1` lets the packager top up a short plan |
