...
The harness picks between them per :envvar:`TABULA_V6_ORBIT_MODE`
...
def submit_orbit(
    ...
    """Dispatch the orbit turn based on ``TABULA_V6_ORBIT_MODE``.
    ...
    """
    mode = os.environ.get("TABULA_V6_ORBIT_MODE", "heuristic").strip().lower()
    if mode == "empty":
