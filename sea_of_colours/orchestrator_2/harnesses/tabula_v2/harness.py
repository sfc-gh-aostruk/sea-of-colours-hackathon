...
Flow per turn:
  ...
  5. Invoke Cortex agent SOC_RED_REAPER_TABULA_V2 (single call, ~30s)
...
AGENT_NAME = "SOC_RED_REAPER_TABULA_V2"
INNER_AGENT_LABEL = "TABULA_V2"
_WALLCLOCK_S = 30
_RESPONSE_CAP = 3_000
_MAX_MOVES = 21
...
def run(
    *, store: Any, session_id: str, player: str, view: Mapping[str, Any],
    ...
    probe_hints = probe_hints_mod.top_probe_hints(agent_view, max_hints=3)
