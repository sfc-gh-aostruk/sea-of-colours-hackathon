"""v9 chat schemas — hermetic-ish overrides on top of the v7 specs.

v9 runs a CONTAINED TWO-STAGE thinker (THINK prose -> PLAN decision) BEFORE the
...
a wall of prose the model spends 25-99s generating (the A4 latency wart). v9's
...
MOVES_RESPONSE_FORMAT = {
    "type": "json_schema",
    "json_schema": {"name": "soc_tabula_v9_moves", "schema": _V9_MOVES_SCHEMA},
}
