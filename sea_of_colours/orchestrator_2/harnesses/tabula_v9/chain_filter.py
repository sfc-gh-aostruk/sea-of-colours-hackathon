"""v9 chain-hint post-filter — dedupe by BODY overlap + a minimum-value floor.
...
This v9-side filter (kept OUT of the shared v7 module so v7/v8 are untouched):
...
from sea_of_colours.orchestrator_2.harnesses.tabula_v7.heuristic_chains import (
    _TIER_MULT,
    _tier_name,
)
