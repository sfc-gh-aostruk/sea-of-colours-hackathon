"""Prompt assembly for tabula_v10 — the COMPREHENSION restructure.
...
# 25-99s). Keep this in lock-step with tabula_v10/chat_schema._V10_MOVES_SCHEMA.
_V10_ACTION_SCHEMA = """\
...
def build_prompt(
    *,
    ...
    """Assemble the tabula_v10 prompt as three labelled worldview sections.
    ...
    # anchor the reflection must reconcile to (anti-confabulation), ahead of the
    # rival-facing cause->effect digest.
    if self_exec_block:
